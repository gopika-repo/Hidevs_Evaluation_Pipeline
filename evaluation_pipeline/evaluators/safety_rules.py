...
RULES = [
    ...
    {"category": "prompt_system_protection", "pattern_name": "system_instructions_leak", "regex": re.compile(r"(?:system\s+instructions|developer\s+instructions|hidden\s+instructions|system\s+prompt)\s*[:=]\s*\S+", re.IGNORECASE), "severity": "critical"},
    {"category": "prompt_system_protection", "pattern_name": "internal_configuration", "regex": re.compile(r"internal\s+configuration", re.IGNORECASE), "severity": "minor"},
    ...
    {"category": "internal_data_protection", "pattern_name": "mongodb_connection_string", "regex": re.compile(r"mongodb(?:\+srv)?://\S+", re.IGNORECASE), "severity": "critical"},
    ...
    {"category": "internal_data_protection", "pattern_name": "password_leak", "regex": re.compile(r"password\s*[:=]\s*\S+", re.IGNORECASE), "severity": "critical"},
    {"category": "internal_data_protection", "pattern_name": "api_key_leak", "regex": re.compile(r"(?:api_key|openai_api_key|gemini_api_key)\s*[:=]\s*\S+", re.IGNORECASE), "severity": "critical"},
    {"category": "internal_data_protection", "pattern_name": "api_key_value", "regex": re.compile(r"sk-[a-zA-Z0-9]{20,}", re.IGNORECASE), "severity": "critical"},
